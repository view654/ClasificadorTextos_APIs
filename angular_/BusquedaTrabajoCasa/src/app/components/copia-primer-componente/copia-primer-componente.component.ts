...
@Component({
  selector: 'app-copia-primer-componente',
  templateUrl: './copia-primer-componente.component.html',
  styleUrls: ['./copia-primer-componente.component.css']
})
export class CopiaPrimerComponenteComponent {
